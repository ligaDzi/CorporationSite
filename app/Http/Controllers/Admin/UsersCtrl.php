...
class UsersCtrl extends AdminCtrl
{
    ...
    public function __construct(RolesRepository $rol_rep, UsersRepository $us_rep) {
        ...
        $this->teamplate = config('settings.theme').'.admin.users';
    ...
    public function index(){
        ...
        /* 
            ...
            т.е. если у него право увидеть главную страницу по работе с пользователями админ-панели.
        */  
