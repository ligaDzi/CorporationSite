...
<div id="content-blog" class="content group">
            ...
            <div class="hentry hentry-post blog-big group">
                ...
                <div class="thumbnail">
                    ...
                    <div class="image-wrap">
                        <img src="{{ asset(config('settings.theme')) }}/images/articles/{{ $article->img->max }}" alt="003" title="003" />        
                    </div>
                    <p class="date">
                ...
                <div class="meta group">
                    ...
                    <p class="comments"><span>
                        <a href="{{ route('articles.show', ['alias'=>$article->alias]) }}#respond" title="Comment on Nice &amp; Clean. The best for your blog!">{{ count($article->comments) ? count($article->comments) : '0' }} {{ Lang::choice('ru.comments', count($article->comments)) }}</a>
                    </span></p>
                </div>
                <!-- post content -->
    ...
    @else
    <!-- @trans() и @Lang::get() один и тот же метод возвращающий значения из файлов локализации. -->
