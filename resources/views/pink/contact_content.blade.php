	            ...
	            <fieldset>
	                <ul>
	                    <li class="text-field">
	                        ...
	                        <br />					<span class="sublabel">{{ Lang::get('ru.this_is') }} {{ Lang::get('ru.name') }}</span><br />
	                        </label>
	                    ...
	                    <li class="text-field">
	                        ...
	                        <br />					<span class="sublabel">{{ Lang::get('ru.this_is') }} {{ Lang::get('ru.email') }}</span><br />
	                        </label>
	                        <div class="input-prepend"><span class="add-on"><i class="icon-envelope"></i></span><input type="email" name="email" id="email-contact-us" class="required email-validate" value="" /></div>
	                        <div class="msg-error"></div>
	                    </li>
	                    <li class="textarea-field">
	                        <label for="message-contact-us">
	                        <span class="label">{{ Lang::get('ru.message') }}</span>
	                        </label>
	                    ...
	                    <li class="submit-button">
	                        ...
	                        <input type="submit" name="yit_sendmail" value="{{ Lang::get('ru.send_message') }}" class="sendmail alignright" />			
	                    </li>
	                </ul>
	            </fieldset>
	        </form>
