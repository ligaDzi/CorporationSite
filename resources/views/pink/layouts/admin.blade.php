<!DOCTYPE html>    
    ...
    <head>        
        ...
        <link rel="stylesheet" type="text/css" media="all" href="{{ asset(config('settings.theme')) }}/jquery_ui/jquery-ui.min.css" /> <!-- jQuery UI STYLESHEET -->      
        ...
        <script type="text/javascript" src="{{ asset(config('settings.theme')) }}/jquery_ui/jquery-ui.min.js"></script>
