...
<![endif]-->
    ...
    <!-- START BODY -->
    <body class="no_js responsive {{ (Route::currentRouteName() == 'home') ||  (Route::currentRouteName() == 'portfolios') ||  (Route::currentRouteName() == 'portfolio.show') ? 'page-template-home-php' : '' }} stretched">
        ...
        <div class="bg-shadow">
            ...
            <div id="wrapper" class="group">
                    ...
                    <div class="group inner">
                        ...
                        <div id="sidebar-header" class="group">
                            <div class="widget-first widget yit_text_quote">
                                <blockquote class="text-quote-quote">&#8220;Живопись - это немая поэзия, а поэзия - это слепая живопись.&#8221;</blockquote>
                                <cite class="text-quote-author">Плутарх</cite>
                            </div>
                        </div>
                ...
                @if(Route::currentRouteName() == 'portfolios')
                    <!-- START PAGE META -->
				    <div id="page-meta">
				        <div class="inner group">
				            <h3>{{ Lang::get('ru.welcome') }}</h3>
				            <h4>... {{ Lang::get('ru.hope') }}</h4>
				        </div>
				    </div>
				    <!-- END PAGE META -->
                @endif
                ...
                @if(Route::currentRouteName() == 'contacts')
				    ...
				    <div id="page-meta">
				        <div class="inner group">
				            <h3>{{ Lang::get('ru.hello') }}</h3>
				            <h4>... {{ Lang::get('ru.get_in_touch') }}</h4>
				        </div>
				    </div>
				    <!-- END PAGE META -->
                @endif
