					...
					@foreach($portfolios as $portfolio)
	    	        	<div class="hentry work group">
	    	        	    ...
	    	        	    <div class="work-description">
	    	        	        ...
	    	        	        <a class="read-more" href="{{ route('portfolio.show', ['alias'=>$portfolio->alias]) }}">{{ Lang::get('ru.read_more') }}</a>            
	    	        	    </div>
	    	        	    <div class="clear"></div>
	    	        	</div>
					@endforeach
				...
				<div class="general-pagination group">
        		    @if($portfolios->lastPage() > 1)
        		        ...
        		        @if($portfolios->currentPage() !== 1)
        		            ...
        		            <a href="{{ $portfolios->url($portfolios->currentPage() - 1) }}">{!! trans('pagination.previous') !!}</a>
        		        ...
        		        @if($portfolios->currentPage() !== $portfolios->lastPage())
        		            ...
        		            <a href="{{ $portfolios->url($portfolios->currentPage() + 1) }}">{!! trans('pagination.next') !!}</a>
