...
<div id="slider-cycle" class="slider cycle no-responsive slider_cycle group" style="height:485px;">
    <ul class="slider">
        ...
        <!-- Здесь испльзуется моя собственная директива описанная в app/Http/Providers/AppServiceProviders -->
        @set($i, 1)
    ...
    <div id="yit-widget-area" class="group">
        <div class="yit-widget-content inner group">
            <div class="widget-first yit-widget widget col1_4 one-fourth col widget-icon-text group">
                <img class="icon-img" src="{{ config('settings.theme') }}/images/icons/cloud.jpg" alt="" />		
                <h3>Great Design</h3>
            ...
            <div class="yit-widget widget col1_4 one-fourth col widget-last-post group">
                <img class="icon-img" src="{{ config('settings.theme') }}/images/icons/blog1.png" alt="" />        
                <div>
            ...
            <div class="widget-last yit-widget widget col1_4 one-fourth col yit_text_quote">
                <blockquote class="text-quote-quote">“Время берет на себя труд заканчивать мои произведения”</blockquote>
                <cite class="text-quote-author">Энгр</cite>
            </div>
        </div>
    </div>
</div>
...
<div class="mobile-slider">
    <div class="slider fixed-image inner"><img src="{{ config('settings.theme') }}/images/slider-cycle/cycle-fixed.jpg" alt="" /></div>
</div>
